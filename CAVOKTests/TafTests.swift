...
class TafTests: ObservationTestCase {
    ...
    func testTaf() {
        ...
        XCTAssertEqual(taf.visibility, 10000)
    ...
    func testTafCor() {
        ...
        XCTAssertEqual(taf.supplements!,
                       "BECMG 0923/1002 4000 BR BKN004 TEMPO 1003/1007 0500 FG "
                        + "BECMG 1007/1009 9999 FEW010 BECMG 1010/1012 25010KT")
    }
    ...
    func testTafWithoutTimestamp() {
        ...
        XCTAssertNil(wind.gust)
        XCTAssertNil(wind.variability)
        XCTAssertEqual(taf.visibility, 9999)
        XCTAssertEqual(taf.weather!, "")
    ...
    func testTafFromPreviousMonth() {
        ...
        XCTAssertEqual(taf.from, getDateFor(1, 00, 00, month: 11, year: 2019))
        XCTAssertEqual(taf.to, getDateFor(1, 24, 00, month: 11, year: 2019))
    }
    ...
    func testTafOverlappingMonth() {
        ...
        XCTAssertEqual(taf.from, getDateFor(31, 12, 00, month: 10, year: 2019))
        XCTAssertEqual(taf.to, getDateFor(1, 12, 00, month: 11, year: 2019))
    }
    ...
    func testTafFromPreviousYear() {
        ...
        XCTAssertEqual(taf.from, getDateFor(1, 00, 00, month: 1, year: 2020))
        XCTAssertEqual(taf.to, getDateFor(2, 00, 00, month: 1, year: 2020))
    }
